...
class RolesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("admin.{$module_name}.create", compact('module_title', 'module_name', 'module_icon', 'module_action', 'roles', 'permissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view("admin.{$module_name}.edit", compact('module_title', 'module_name', "{$module_name_singular}", 'module_name_singular', 'module_icon', 'module_action', 'permissions'));
    }
    ...
    public function destroy($id)
    {
        ...
        if ($id == 1) {
            ...
            return redirect()->route("admin.{$module_name}.index");
