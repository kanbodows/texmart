...
@section("content")
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    {{ html()->modelForm($$module_name_singular, "PATCH", route("admin.$module_name.update", $$module_name_singular->id))->class("form-horizontal")->open() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="float-end">
                                ...
                                <x-admin.buttons.return-back>Cancel</x-admin.buttons.return-back>
                            </div>
                        </div>
                    </div>
                    {{ html()->form()->close() }}
