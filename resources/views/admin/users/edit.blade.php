...
@section("content")
    <x-admin.layouts.edit :data="$user">
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->modelForm($user, "PATCH", route("admin.users.update", $user->id))->class("form-horizontal")->acceptsFiles()->open() }}

                <div class="form-group row">
                    {{ html()->label(__("labels.admin.users.fields.avatar"))->class("col-md-2 form-label")->for("name") }}
                ...
                <div class="row mb-3">
                    <?php
                    $field_name = "password";
                    $field_lable = __("labels.admin.users.fields.password");
                    $field_placeholder = $field_lable;
                    $required = "required";
                    ?>
                ...
                <div class="row mb-3">
                    ...
                    $field_lable = __("labels.admin.users.fields.confirmed");
                    $field_placeholder = $field_lable;
                    $required = "";
                    ?>
                ...
                <div class="row mb-3">
                    <?php
                    $field_name = "social";
                    $field_lable = __("labels.admin.users.fields.social");
                    $field_placeholder = $field_lable;
                    $required = "";
                    ?>
                        ...
                        <div class="float-end">
                            @if ($$module_name_singular->status != 2 && $$module_name_singular->id != 1)
                                    <a
                                        ...
                                        href="{{ route("admin.users.block", $$module_name_singular) }}"
                            ...
                            @if ($$module_name_singular->status == 2)
                                    <a
                                        ...
                                        data-toggle="tooltip"
                                        data-confirm="Are you sure?"
                                        href="{{ route("admin.users.unblock", $$module_name_singular) }}"
                            ...
                            @if ($$module_name_singular->email_verified_at == null)
                                    <a
                                        ...
                                        data-toggle="tooltip"
                                        href="{{ route("admin.users.emailConfirmationResend", $$module_name_singular->id) }}"
                                        title="Send Confirmation Email"
                                    >
                                        <i class="fas fa-envelope"></i>
                                    </a>
                            ...
                            @if ($$module_name_singular->id != 1)
                                    <a
                                        ...
                                        data-token="{{ csrf_token() }}"
                                        data-toggle="tooltip"
                                        href="{{ route("admin.$module_name.destroy", $$module_name_singular) }}"
                            ...
                            <x-admin.buttons.return-back>@lang("Cancel")</x-admin.buttons.return-back>
                        </div>
                    </div>
                </div>
                {{ html()->closeModelForm() }}
