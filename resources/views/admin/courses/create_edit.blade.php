        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ isset($post) ? 'Редактировать' : 'Создать' }} запись</h4>
                </div>

                <form action="{{ isset($post) ? route('admin.courses.update', $post->id) : route('admin.courses.store') }}"
                      method="POST"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    @error('video')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Вставьте код iframe для встраивания видео (например, с YouTube)</small>
                                </div>
                            </div>
